...
if ( ! class_exists( 'ChurchPlugins_1_1_7', false ) ) {
	...
	class ChurchPlugins_1_1_7 {
		 ...
		 *
		 * @since  1.0.0
		 * @return ChurchPlugins_1_1_7 Single instance object
		 */
	...
	return ChurchPlugins_1_1_7::initiate();
