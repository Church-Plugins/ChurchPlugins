...
if ( ! class_exists( 'ChurchPlugins_1_1_16', false ) ) {
	...
	class ChurchPlugins_1_1_16 {
		 ...
		 *
		 * @since  1.0.0
		 * @return ChurchPlugins_1_1_16 Single instance object
		 */
		...
		public function include_churchplugins() {
			...
			do_action( 'cp_core_files_included' );
	...
	return ChurchPlugins_1_1_16::initiate();
