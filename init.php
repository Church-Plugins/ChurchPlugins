...
if ( ! class_exists( 'ChurchPlugins_1_1_5', false ) ) {
	...
	class ChurchPlugins_1_1_5 {
		 ...
		 *
		 * @since  1.0.0
		 * @return ChurchPlugins_1_1_5 Single instance object
		 */
	...
	return ChurchPlugins_1_1_5::initiate();
