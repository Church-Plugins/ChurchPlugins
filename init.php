...
if ( ! class_exists( 'ChurchPlugins_1_1_9', false ) ) {
	...
	class ChurchPlugins_1_1_9 {
		 ...
		 *
		 * @since  1.0.0
		 * @return ChurchPlugins_1_1_9 Single instance object
		 */
	...
	return ChurchPlugins_1_1_9::initiate();
