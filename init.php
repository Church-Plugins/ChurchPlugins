...
if ( ! class_exists( 'ChurchPlugins_1_1_4', false ) ) {
	...
	class ChurchPlugins_1_1_4 {
		 ...
		 *
		 * @since  1.0.0
		 * @return ChurchPlugins_1_1_4 Single instance object
		 */
	...
	return ChurchPlugins_1_1_4::initiate();
